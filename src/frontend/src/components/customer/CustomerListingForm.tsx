...
/** The empty draft used when a customer creates a new listing. */
export const EMPTY_CUSTOMER_LISTING_FORM: ListingFormValues = {
  title: "",
  description: "",
...
/** Maps a stored listing onto the editable customer form shape. */
export function listingToCustomerFormValues(
  listing: Listing,
): ListingFormValues {
  return {
    title: listing.title,
...
interface CustomerListingFormProps {
  ...
  /** Called when the customer cancels editing. */
  onCancel: () => void;
  ...
  submitLabel: string;
  /** Photos already attached to the listing, when editing. */
  photos?: Photo[];
  /** Persists newly uploaded photos. */
...
/**
 * The customer-facing property form. It mirrors the administrator field set but
 * is styled for the public site and carries the customer photo uploader.
 */
export function CustomerListingForm({
  values,
  onChange,
  onSubmit,
  onCancel,
  ...
  return (
    <form
      data-ocid="customer_listing_form"
      onSubmit={handleSubmit}
      noValidate
      className="space-y-6"
    >
      <section className="rounded-2xl border border-border bg-card p-6 shadow-subtle md:p-7">
        ...
        <div className="mt-5 grid gap-4 md:grid-cols-2">
          ...
          >
            <Input
              id="customer-listing-title"
              data-ocid="customer_listing_form.title_input"
              value={values.title}
          ...
          <Field
            id="customer-listing-description"
            label="Description"
          ...
          >
            <Textarea
              id="customer-listing-description"
              data-ocid="customer_listing_form.description_textarea"
          ...
          <Field id="customer-listing-type" label="Listing type">
            <Select
            ...
            >
              <SelectTrigger
                id="customer-listing-type"
                data-ocid="customer_listing_form.listing_type_select"
          ...
          <Field id="customer-property-type" label="Property type">
            <Select
            ...
            >
              <SelectTrigger
                id="customer-property-type"
                data-ocid="customer_listing_form.property_type_select"
                className="h-11 w-full rounded-xl"
              >
          ...
          <Field id="customer-listing-price" label="Price" error={errors.price}>
            <Input
              id="customer-listing-price"
              data-ocid="customer_listing_form.price_input"
              inputMode="numeric"
              value={values.price}
              placeholder="1300000"
          ...
          <Field id="customer-listing-currency" label="Currency">
            <Select
              value={values.currency}
              onValueChange={(value) => set("currency", value)}
            >
              <SelectTrigger
                id="customer-listing-currency"
                data-ocid="customer_listing_form.currency_select"
                className="h-11 w-full rounded-xl"
              >
      ...
      <section className="rounded-2xl border border-border bg-card p-6 shadow-subtle md:p-7">
        ...
        <div className="mt-5 grid gap-4 md:grid-cols-2">
          ...
          >
            <Input
              id="customer-listing-address"
              data-ocid="customer_listing_form.address_input"
          ...
          <Field id="customer-listing-city" label="City" error={errors.city}>
            <Input
              id="customer-listing-city"
              data-ocid="customer_listing_form.city_input"
              value={values.city}
              placeholder="Galle"
          ...
          <Field
            id="customer-listing-region"
            label="Region"
            error={errors.region}
          >
            <Input
              id="customer-listing-region"
              data-ocid="customer_listing_form.region_input"
              value={values.region}
          ...
          <Field id="customer-listing-postcode" label="Postcode">
            <Input
              id="customer-listing-postcode"
              data-ocid="customer_listing_form.postcode_input"
          ...
          <Field
            id="customer-listing-country"
            label="Country"
            error={errors.country}
          >
            <Input
              id="customer-listing-country"
              data-ocid="customer_listing_form.country_input"
      ...
      <section className="rounded-2xl border border-border bg-card p-6 shadow-subtle md:p-7">
        ...
        <div className="mt-5 grid gap-4 sm:grid-cols-3">
          <Field
            id="customer-listing-bedrooms"
            label="Bedrooms"
            error={errors.bedrooms}
          >
            <Input
              id="customer-listing-bedrooms"
              data-ocid="customer_listing_form.bedrooms_input"
              inputMode="numeric"
          ...
          <Field
            id="customer-listing-bathrooms"
            label="Bathrooms"
            error={errors.bathrooms}
          >
            <Input
              id="customer-listing-bathrooms"
              data-ocid="customer_listing_form.bathrooms_input"
              inputMode="numeric"
          ...
          <Field
            id="customer-listing-area"
            label="Area (sq ft)"
            error={errors.area}
          >
            <Input
              id="customer-listing-area"
              data-ocid="customer_listing_form.area_input"
              inputMode="numeric"
              value={values.area}
              placeholder="2400"
      ...
      {errorMessage ? (
        <p
          data-ocid="customer_listing_form.error_state"
          role="alert"
      ...
      <div className="flex flex-col-reverse gap-3 sm:flex-row sm:justify-end">
        <Button
          type="button"
          variant="outline"
          data-ocid="customer_listing_form.cancel_button"
          disabled={isSaving}
          onClick={onCancel}
        ...
        <Button
          type="submit"
          data-ocid="customer_listing_form.submit_button"
          disabled={isSaving}
...
function Field({ id, label, error, className, children }: FieldProps) {
  return (
    <div className={cn("space-y-1.5", className)}>
      ...
      {error ? (
        <p
          data-ocid={`customer_listing_form.${id.replace("customer-listing-", "")}_error`}
